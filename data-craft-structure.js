const questionBank_CS = [
  ...
  },
  {
    ...
    "skill": "Cross-Text Connections",
    "difficulty": "Easy",
    "passage": "Text 1 On April 26th, 1777, Sybil Ludington rode 40 miles by horse through Putnam County, New York, to gather up local militia. British forces were burning nearby Danbury, Connecticut, and Ludington wanted to rally rebel troops to meet them. Although she was only 16 years old at the time, her brave feat made Ludington one of the heroes of the American Revolution. Since then, Ludington has been widely celebrated, inspiring postage stamps, statues, and even children’s TV series.\n\nText 2 Historian Paula D. Hunt researched the life and legacy of Sybil Ludington but found no evidence for her famous ride. Although many articles and books have been written about Ludington, Hunt believes writers may have been inventing details about Ludington as they retold her story. Ludington is revered by Americans today, but there simply isn’t a strong historical record of her heroic ride.",
  ...
  },
  {
    ...
    "skill": "Words in Context",
    "difficulty": "Hard",
    "passage": "Scholarly discussions of gender in Shakespeare’s comedies often celebrate the rebellion of the playwright’s characters against the rigid expectations ______ by Elizabethan society. Most of the comedies end in marriage, with characters returning to their socially dictated gender roles after previously defying them, but there are some notable exceptions.",
    "question": "Which choice completes the text with the most logical and precise word or phrase?",
    "options": [
      "A. interjected",
      "B. committed",
  ...
  },
  {
    ...
    "skill": "Cross-Text Connections",
    "difficulty": "Medium",
    "passage": "Text 1 Stage lighting theorist Adolphe Appia was perhaps the first to argue that light must be considered alongside all the various elements of a stage to create a single, unified performance. Researcher Kelly Bremner, however, has noted that Appia lacked technical expertise in the use of light in the theater. As a result of Appia’s inexperience, Bremner argues, Appia’s theory of light called for lighting practices that weren’t possible until after the advent of electricity around 1881.\n\nText 2 Adolphe Appia was not an amateur in the practice of lighting. Instead, it is precisely his exposure to lighting techniques at the time that contributed to his theory on the importance of light. When working as an apprentice for a lighting specialist in his youth, Appia observed the use of portable lighting devices that could be operated by hand. This experience developed his understanding of what was possible in the coordination of elements on the stage.",
  ...
  },
  {
    ...
    "skill": "Text Structure and Purpose",
    "difficulty": "Hard",
    "passage": "In Jane Austen’s novel Mansfield Park, an almost imperceptible smile from potential suitor Henry Crawford causes the protagonist Fanny Price to blush; her embarrassment grows when she suspects that he is aware of it. This moment—in which Fanny not only infers Henry’s mental state through his gestures, but also infers that he is drawing inferences about her mental state—illustrates what literary scholar George Butte calls “deep intersubjectivity,” a technique for representing interactions between consciousnesses through which Austen’s novels derive much of their social and psychological drama.",
  ...
  },
  {
    ...
    "skill": "Cross-Text Connections",
    "difficulty": "Hard",
    "passage": "Text 1 Like the work of Ralph Ellison before her, Toni Morrison’s novels feature scenes in which characters deliver sermons of such length and verbal dexterity that for a time, the text exchanges the formal parameters of fiction for those of oral literature. Given the many other echoes of Ellison in Morrison’s novels, both in structure and prose style, <u>these scenes suggest Ellison’s direct influence on Morrison.</u> Text 2 In their destabilizing effect on literary form, the sermons in Morrison’s works recall those in Ellison’s. Yet literature by Black Americans abounds in moments where interpolated speech erodes the division between oral and written forms that literature in English has traditionally observed. Morrison’s use of the sermon is attributable not only to the influence of Ellison but also to a community-wide strategy of resistance to externally imposed literary conventions.",
  ...
  },
  {
    ...
    "skill": "Cross-Text Connections",
    "difficulty": "Hard",
    "passage": "Text 1 Virginia Woolf’s 1928 novel Orlando is an oddity within her body of work. Her other major novels consist mainly of scenes of everyday life and describe their characters’ interior states in great detail, whereas Orlando propels itself through a series of fantastical events and considers its characters’ psychology more superficially. Woolf herself sometimes regarded the novel as a minor work, even admitting once that she “began it as a joke.”\n\nText 2 Like Woolf’s other great novels, Orlando portrays how people’s memories inform their experience of the present. Like those works, it examines how people navigate social interactions shaped by gender and social class. Though it is lighter in tone—more entertaining, even—this literary “joke” nonetheless engages seriously with the themes that motivated the four or five other novels by Woolf that have achieved the status of literary classics.",
  ...
  },
  {
    ...
    "skill": "Words in Context",
    "difficulty": "Easy",
    "passage": "The following text is from Booth Tarkington’s 1921 novel Alice Adams. Mrs. Adams had always been fond of vases, she said, and every year her husband’s Christmas present to her was a vase of one sort or another—whatever the clerk showed him, marked at about twelve or fourteen dollars.",
  ...
  },
  {
    ...
    "skill": "Cross-Text Connections",
    "difficulty": "Hard",
    "passage": "Text 1 Growth in the use of novel nanohybrids—materials created from the conjugation of multiple distinct nanomaterials, such as iron oxide and gold nanomaterials conjugated for use in magnetic imaging—has outpaced studies of nanohybrids’ environmental risks. Unfortunately, risk evaluations based on nanohybrids’ constituents are not reliable: <u>conjugation may alter constituents’ physiochemical properties such that innocuous nanomaterials form a nanohybrid that is anything but.</u> Text 2 The potential for enhanced toxicity of nanohybrids relative to the toxicity of constituent nanomaterials has drawn deserved attention, but the effects of nanomaterial conjugation vary by case. For instance, it was recently shown that a nanohybrid of silicon dioxide and zinc oxide preserved the desired optical transparency of zinc oxide nanoparticles while mitigating the nanoparticles’ potential to damage DNA.",
  ...
  },
  {
    ...
    "skill": "Cross-Text Connections",
    "difficulty": "Medium",
    "passage": "Text 1 In a study of insect behavior, Samadi Galpayage and colleagues presented bumblebees with small wooden balls and observed many of the bees clinging to, rolling, and dragging the objects. The researchers provided no external rewards (such as food) to encourage these interactions. <u>The bees simply appeared to be playing—and for no other reason than because they were having</u> fun. Text 2 Insects do not have cortexes or other brain areas associated with emotions in humans. Still, Galpayage and her team have shown that bumblebees may engage in play, possibly experiencing some kind of positive emotional state. Other studies have suggested that bees experience negative emotional states (for example, stress), but as Galpayage and her team have acknowledged, emotions in insects, if they do indeed exist, are likely very rudimentary.",
  ...
  },
  {
    ...
    "skill": "Words in Context",
    "difficulty": "Easy",
    "passage": "The following text is from Yann Martel’s 2001 novel Life of Pi. The narrator’s family owned a zoo when he was a child. It was a huge zoo, spread over numberless acres, big enough to require a train to explore it, though it seemed to get smaller as I grew older, train included. ©2001 by Yann Martel",
  ...
  },
  {
    ...
    "skill": "Cross-Text Connections",
    "difficulty": "Easy",
    "passage": "Text 1\nItalian <u>painters in <u>the</u></u> 1500s rarely depicted themselves in <u>their</u> work. Even more rare were self-portrait paintings that portrayed the\n<u>artist</u> as <u><u>a</u></u> painter. At the time, <u>painting was</u> not yet respected as a <u>profession, so</u> painters <u>mostly chose <u>to</u> emphasize other qualities</u> in their <u>self-portraits, like</u> their intellect or social status. <u>In</u> the <u>city of Bologna,</u> the <u>first</u> artist to <u>depict themself</u> painting\nwas a <u>man named Annibale Carracci.</u> A painting of his from around 1585 shows Carracci in front of an easel holding a palette.\n\nText 2\nIn their self-portraits, Bolognese artists typically avoided referring to the act of painting until the mid-1600s. However, Lavinia\nFontana's 1577 painting, Self-Portrait at the Keyboard, stands out as the earliest example of such a work by an artist from Bologna.\nAlthough the artist is depicted playing music, in the background, one can spot a painting easel by a window.",
    "question": "Based on the texts, how would the author of Text 2 most likely respond to the underlined claim in Text 1?",
    "options": [
      "A. Carracci and Fontana were among the most well-respected painters in Bologna at the time.",
      "B. The depiction of Fontana in Self-Portrait at the Keyboard was intended to underscore the artist's creativity.",
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "Strategy: Perspective Synthesis\nWatch for: One-Sided Focus · Qualification as Disagreement · Shared Topic = Agreement\n────────────────────────────────────────\nChoice C is the correct answer. (Full official explanation unavailable for this question — use the strategy cue and trap set above to reason through the answer choices.)",
    "strategy": "Perspective Synthesis"
  },
  {
    "id": "c966ad55",
  ...
  },
  {
    ...
    "skill": "Cross-Text Connections",
    "difficulty": "Easy",
    "passage": "Text 1\nIn a study of insect behavior, Samadi Galpayage <u>and</u> colleagues presented bumblebees with small wooden balls and observed\nmany of <u>the bees</u> clinging <u><u>to</u></u>, rolling, and <u>dragging</u> the <u>objects. <u>The</u> researchers provided <u>no</u> external rewards (such as food)</u> to\nencourage these interactions. The bees <u>simply appeared</u> to <u>be playing—and for</u> no <u>other reason than because they were having</u>\nfun.\nText 2\nInsects do not have cortexes or other brain areas associated with emotions in humans. Still, Galpayage and her team have shown\nthat bumblebees may engage in play, possibly experiencing some kind of positive emotional state. Other studies have suggested\nthat bees experience negative emotional states (for example, stress), but as Galpayage and her team have acknowledged,\nemotions in insects, if they do indeed exist, are likely very rudimentary.",
    "question": "Based on the texts, how would the author of Text 2 most likely respond to the underlined portion of Text 1?",
    "options": [
      "A. By objecting that the bees were actually experiencing a negative feeling akin to stress rather than a positive feeling",
      "B. By arguing that some insects other than bumblebees may be capable of experiencing complex emotional states",
  ...
  },
  {
    ...
    "skill": "Words in Context",
    "difficulty": "Easy",
    "passage": "Scientists previously thought that all electric eels belong to a single species, but a team of researchers led by zoologist C. David de\nSantana proved this idea wrong by ______ that there are in fact three distinct species of electric eels.",
    "question": "Which choice completes the text with the most logical and precise word or phrase?",
    "options": [
      "A. pretending",
      "B. complaining",
  ...
  },
  {
    ...
    "question": "Which choice best describes the overall structure of the text?",
    "options": [
      "A. It shows that Mr. Ely had originally been held in high regard by his friends and then details the events that caused their regard",
      "B. It implies that Mr. Ely's neighbors are more naïve in their estimation of him than people in London are and then explains why his neighbors have been so easily misled.",
      "C. It stresses the discrepancy between Mr. Ely's public and private conduct and then alludes to his motivation for hiding his true personality.",
      "D. It presents the favorable opinion of Mr. Ely that other people hold and then describes the behaviors of Mr. Ely that enable him to maintain that favorable opinion."
    ],
    "answer": "D",
    "explanation": "Choice D is the best answer because it best describes the overall structure of the text. The first part of the text presents the\nfavorable opinions that others hold of Mr. Ely: the laity of Milby regard him as having \"remarkable powers and learning\" and\nassume that he also impresses people in London, while his fellow clergy see him as \"a discreet and agreeable fellow.\" The text\nthen goes on to describe Mr. Ely's behaviors that enable him to cultivate and preserve his positive reputation. The text conveys that\nhe avoids confrontations, abstaining from \"warm discussion[s]\" (that is, heated or contentious ones); that he avoids offending\nanyone by \"rarely [saying] what he thought himself\" and by refraining from openly ridiculing anyone; and that he doesn't give\nanyone any reason to ridicule or belittle his own character (\"he never gave any one an opportunity of laughing at him\"). In other\nwords, these are all behaviors that suggest that Mr. Ely avoids doing anything that might make people dislike him or think poorly of\nhim. Thus, the text begins by presenting the favorable view that people have of Mr. Ely and then describes the behaviors that\nenable him to maintain that favorable view.\n\nChoice A is incorrect because the text doesn't describe any events that caused people's regard for Mr. Ely to diminish. Instead, the\ntext explains that the people of Milby hold him in high regard and describes behaviors that suggest how he cultivates that regard.\nChoice B is incorrect because the text doesn't suggest that Mr. Ely's neighbors are more naïve than Londoners are or that they've\n\fbeen misled. Although the text suggests that Mr. Ely is very guarded in his outward behavior and conceals from people when he\nmay be internally mocking them, which might suggest that people know him less well than they think they do, there's nothing in the\ntext to suggest that Londoners are less naïve and therefore less easily misled than Mr. Ely's neighbors are. The text states that the\npeople of Milby believe Mr. Ely to be \"remarkable\" and that they assume that people in London must find him so, too; it doesn't say\nanything about what Londoners actually think of him. Choice C is incorrect. While the text discusses Mr. Ely's public conduct at\nlength, describing the ways in which he carefully cultivates an agreeable public persona, the text doesn't discuss how Mr. Ely\nbehaves in private at all; it therefore wouldn't be accurate to say that the text begins by emphasizing a discrepancy between his\npublic and private conduct. Furthermore, although the text concludes with examples illustrating that Mr. Ely typically doesn't share\nhis true thoughts, indicating that he may be hiding aspects of his true personality when in public, and although the text as a whole\nconveys the idea that Mr. Ely benefits from this behavior, which might hint at his motives for doing so, the text doesn't conclude by\nalluding to those motives. Instead, the text merely concludes with a description of the behaviors he engages in to win his\nneighbors' and colleagues' approval.",
    "strategy": "Function Map"
  },
  {
    "id": "f52cc78c",
    "skill": "Cross-Text Connections",
    "difficulty": "Medium",
    "passage": "Text 1\nPolar bears sustain themselves primarily <u><u>by</u></u> hunting seals on <u><u>the</u></u> Arctic sea ice, but rising ocean temperatures <u>are</u> causing the ice\n<u>to</u> diminish, raising concerns about <u>polar bear</u> population declines as these <u>large</u> predators' <u>seal-hunting habitats continue</u> to\n<u>shrink. A 2020 study examining</u> polar bear <u><u>populations</u></u> across the Arctic <u>concluded that</u> populations <u>affected</u> by <u>sea-ice loss</u> are <u>at great risk <u>of</u> extinction</u> by the <u>end</u> of the <u>twenty-first century.</u>\nText 2\nMonitoring carried out by researchers from the Norwegian Polar Institute shows that the polar bear population on the Arctic\narchipelago of Svalbard remains stable and well nourished despite rapidly declining sea ice in recent years. The researchers\nattribute this population's resilience in part to a shift in feeding strategies: in addition to hunting seals, the Svalbard polar bears\nhave begun relying on a diet of reindeer meat and birds' eggs.",
  ...
  },
  {
    ...
    "skill": "Words in Context",
    "difficulty": "Medium",
    "passage": "Like the 1945 play it reimagines—Federico García Lorca's The House of Bernarda Alba—Marcus Gardley's 2014 play The House\nThat Will Not Stand prominently features women. In both plays, the all-female cast ______ an array of female characters, including\na strong mother and several daughters dealing with individual struggles.",
    "question": "Which choice completes the text with the most logical and precise word or phrase?",
    "options": [
      "A. engulfs",
      "B. encourages",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "Strategy: Function Map\nWatch for: Topic Match Function Miss · Part-for-Whole · Intensity Mismatch\n────────────────────────────────────────\nChoice A is the correct answer. (Full official explanation unavailable for this question — use the strategy cue and trap set above to reason through the answer choices.)",
    "strategy": "Function Map"
  },
  {
    "id": "f1c9d2c1",
  ...
  },
  {
    ...
    "answer": "D",
    "explanation": "Choice D is the best answer because it reflects how the author of Text 1 would most likely respond to Text 2 based on the\ninformation provided. Text 2 discusses how the inconsistent use of credits to identify the contributors to video games can pose an\nobstacle to scholars of the medium, who rely on such credits to answer questions about the medium's development. Text 1 notes\nthat in film and television, on the other hand, credits are used consistently and are valuable to researchers studying the cast and\ncrew members in these mediums. Since Text 1 asserts how the consistent use of credits benefits scholars of film and television, it\ncan be inferred that this text's author would respond to the discussion in Text 2 by observing that the kind of problem faced by\nscholars of video games—the inability to know who contributed to a particular production and how—is, in film and television\nstudies, largely prevented by the widespread practice of credits in these mediums.\n\fChoice A is incorrect. Although Text 1 discusses a method used by film and television researchers—namely, relying on credits to\nresearch the careers of cast and crew members—the author doesn't explicitly recommend that or any other method. Moreover,\nText 1 states that films and television shows themselves, not their researchers, regularly use the method of listing credits. Choice\nB is incorrect. It can be inferred from Text 2 that when video games do feature credits, they have essentially the same function as\ncredits in film and television—namely, to identify the individuals who worked on a particular production. Therefore, it is unlikely that\nthe author of Text 1 would characterize video game credits as differing in purpose from film and television credits. Choice C is\nincorrect because, as Text 2 explains, credits are not consistently used in video games. Therefore, it is unlikely that the author of\nText 1 would argue that scholars of the medium discussed in this text—video games—rely more heavily on credits than scholars of\nfilm and television, two mediums where credits consistently appear.",
    "strategy": "Perspective Synthesis"
  },
  {
    "id": "10c236ce",
  ...
  },
  {
    ...
    "question": "Which choice best states the main purpose of the text?",
    "options": [
      "A. To indicate the specific tarweed ancestor of all plants that grow on the Hawaiian Islands and explain why the plants have such",
      "B. To describe the specific habitat where Dubautia carrii are found and identify other plants that share a common ancestor with them",
      "C. To describe the silversword alliance and explain how the plant family became so varied",
      "D. To advance the claim that all plants on the Hawaiian Islands are part of the silversword alliance and list possible ancestors of the plants that make up the alliance"
    ],
  ...
  },
  {
    ...
    "skill": "Cross-Text Connections",
    "difficulty": "Hard",
    "passage": "Text 1\nGrowth in the use <u>of</u> novel nanohybrids—materials created from the <u>conjugation</u> of multiple distinct <u>nanomaterials</u>, <u>such</u> as iron\noxide and gold nanomaterials conjugated for use in magnetic imaging—has outpaced <u>studies</u> of nanohybrids' environmental risks.\n<u>Unfortunately, risk evaluations based on</u> nanohybrids' <u>constituents are not reliable:</u> conjugation <u>may alter</u> constituents'\n<u>physiochemical properties</u> such <u><u>that</u> innocuous</u> nanomaterials <u>form a nanohybrid</u> that <u>is anything but.</u>\nText 2\nThe potential for enhanced toxicity of nanohybrids relative to the toxicity of constituent nanomaterials has drawn deserved\nattention, but the effects of nanomaterial conjugation vary by case. For instance, it was recently shown that a nanohybrid of silicon\ndioxide and zinc oxide preserved the desired optical transparency of zinc oxide nanoparticles while mitigating the nanoparticles'\npotential to damage DNA.",
    "question": "Based on the texts, how would the author of Text 2 most likely respond to the assertion in the underlined portion of Text 1?",
    "options": [
      "A. By concurring that the risk described in Text 1 should be evaluated but emphasizing that the risk is more than offset by the potential benefits of nanomaterial conjugation",
      "B. By arguing that the situation described in Text 1 may not be representative but conceding that the effects of nanomaterial conjugation are harder to predict than researchers had expected",
  ...
  },
  {
    ...
    "skill": "Cross-Text Connections",
    "difficulty": "Hard",
    "passage": "Text 1\nIn 2007, <u>a</u> team led by Alice Storey analyzed a <u><u>chicken</u></u> bone found in El <u>Arenal</u>, Chile, dating it <u>to</u> 1321–1407 CE—over a century\nbefore Europeans invaded <u><u>the</u></u> region, bringing their own <u>chickens</u>. Storey also found that the El Arenal chicken <u>shared</u> a unique\n<u>genetic mutation with</u> the <u>ancient</u> chicken <u>breeds of</u> the <u>Polynesian</u> Islands in the Pacific. Thus, Polynesian <u>peoples, not later Europeans, probably first introduced</u> chickens to <u>South America.</u>\n\nText 2\nAn Australian research team weakened the case for a Polynesian origin for the El Arenal chicken by confirming that the mutation\nidentified by Storey has occurred in breeds from around the world. More recently, though, a team led by Agusto Luzuriaga-Neira\nfound that South American chicken breeds and Polynesian breeds share other genetic markers that European breeds lack. Thus,\nthe preponderance of evidence now favors a Polynesian origin.",
    "question": "Based on the texts, how would the author of Text 2 most likely respond to the underlined claim in Text 1?",
    "options": [
      "A. By broadly agreeing with the claim but objecting that the timeline it presupposes conflicts with the findings of the genetic analysis conducted by Storey's team",
      "B. By faulting the claim for implying that domestic animals couldn't have been transferred from South America to the Polynesian Islands as well",
    ...
    "answer": "D",
    "explanation": "Choice D is the best answer because it accurately describes how the author of Text 2 would most likely respond to the underlined\nclaim in Text 1. Text 1 indicates that Storey found a genetic mutation in South American chickens from before the European\ninvasion and in Polynesian chickens, which implies that chickens were first brought to South America by Polynesian people. Text 2\nexplains that the genetic mutation Storey found is in chickens from all over the world, thus undercutting the mutation as evidence\nof a Polynesian origin. However, Text 2 goes on to say \"[m]ore recently\" Luzuriaga-Neira and colleagues found multiple genetic\nmarkers shared by South American and Polynesian chickens but \"that European breeds lack,\" which strongly suggests a\nPolynesian origin for the South American chickens. This indicates that the author of Text 2 believes Luzuriaga-Neira's evidence for\na Polynesian origin is compelling while Storey's evidence has been undermined. Thus, the author of Text 2 would most likely agree\n\fwith the underlined statement and believes Luzuriaga-Neira and colleagues' evidence for the statement is stronger than Storey's\nevidence is.\n\nChoice A is incorrect because both texts indicate that chickens were introduced to South America before the arrival of Europeans.\nText 1 states that the El Arenal chicken bone dates from \"1321–1407 CE—over a century before Europeans invaded the region\" and\nconcludes that these chickens were likely brought to South America by Polynesians. While Text 2 is not as explicit about the time\nperiod as Text 1 is, nothing in Text 2 undermines the timing of events ascribed to Storey's account in Text 1. Choice B is incorrect\nbecause both texts agree that chickens were first brought to South America by Polynesian peoples (the underlined claim), and\nnothing in Text 2 suggests that this claim is in any way deficient because the possibility that animals could have been transferred\nfrom South America to Polynesia was not explicitly addressed. Choice C is incorrect because the criticism that Text 2 raises about\nthe ideas in Text 1 is specifically about whether the single genetic mutation cited by Storey in fact supports the idea of a\nPolynesian origin for South American chickens. There is nothing in Text 2 to suggest that the underlined sentence (Storey's\nconclusion) is deficient because it is based on an assumption about the genetic uniformity of European chickens.",
    "strategy": "Perspective Synthesis"
  },
  {
    "id": "17bf10de",
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "Choice A is the best answer because it provides a statement about the description of the first showing of Arrival of the Train in\nText 1 that, based on the texts, the author of Text 2 would most likely agree with. Text 1 indicates that members of the audience,\nunaccustomed to the new medium of film and believing that they were looking at a real oncoming train, allegedly reacted to the\nfilm with alarm. Text 1 then goes on to treat this anecdote as a factual account of the film's first showing, interpreting it as a\nmoment that marked a \"major cultural shift.\" In contrast, the author of Text 2 indicates that though the story of the film's first\nshowing has become \"canonical,\" or widely accepted, there is no contemporary evidence to support the idea that the audience\nreacted as Text 1 describes. Text 2 goes on to explain that this factually questionable description likely persists because it\nfunctions as a \"founding myth\" that reinforces a widespread belief in the profoundly transformative nature of the invention of film.\nThis indicates that the author of Text 2 would likely see the description in Text 1 as motivated primarily by cultural perceptions\nabout film's significance rather than by documented historical facts.\n\fChoice B is incorrect because the author of Text 2 doesn't suggest that film historians regard the view about film's transformative\nnature as naïve. On the contrary, Text 2 states that the story of the first showing of Arrival of the Train has become \"canonical, even\namong film historians,\" indicating that historians broadly accept this narrative as a compelling illustration of film's impact, not that\nthey regard either the narrative or the views it conveys about the transformative nature of film as naïve. Text 2 refers to a \"(naïve)\n'before'\" in cultural history, but this is describing how the myth itself characterizes pre-film audiences, not how historians regard\nviews about the transformative nature of film. Choice C is incorrect. While the author of Text 2 does indicate that the story of the\naudience's reaction to Arrival of the Train described in Text 1 is a myth that lacks evidence, the text doesn't suggest that the story\nreflects the fact that film historians believe themselves to be more sophisticated than modern audiences are. Rather, Text 2\nsuggests that the story persists because of a collective cultural belief, which historians share, in the profound impact of the\ninvention of film. Moreover, the \"naïve\" versus \"sophisticated\" distinction mentioned in Text 2 refers to how the myth characterizes\naudiences before and after the invention of film; it doesn't characterize modern audiences versus film historians. Choice D is\nincorrect. Although the author of Text 2 would agree that the description of the first showing of Arrival of the Train in Text 1\nreflects a misconception, the author wouldn't agree that widespread belief in the misconception can be attributed to the fact that it\naccurately captures early audiences' actual sense of alarm. In fact, the misconception identified by the author of Text 2 concerns\nthe accuracy of the audience's alleged reaction; the author questions whether early audiences were alarmed at all, stating there is\n\"no contemporary evidence\" that they reacted in this way. According to Text 2, the description is widely believed not because it\naccurately captures historical reactions but because it serves as a \"founding myth\" that supports a belief in film's transformative\ncultural impact.",
    "strategy": "Perspective Synthesis"
  },
  {
    "id": "c14daa3c",
